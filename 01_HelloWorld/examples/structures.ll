; ModuleID = 'structures.cpp'
source_filename = "structures.cpp"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%"class.std::ios_base::Init" = type { i8 }
%struct.Number = type { i32, i8, double }
...
@__const.main.one = private unnamed_addr constant %struct.Number { i32 1, i8 0, double 1.000000e+00 }, align 8
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_structures.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %3 = bitcast %struct.Number* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %3, i8* align 8 bitcast (%struct.Number* @__const.main.one to i8*), i64 16, i1 false)
  %4 = getelementptr inbounds %struct.Number, %struct.Number* %2, i32 0, i32 0
  %5 = load i32, i32* %4, align 8
  %6 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %5)
  %7 = getelementptr inbounds %struct.Number, %struct.Number* %2, i32 0, i32 0
  %8 = load i32, i32* %7, align 8
  %9 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %6, i32 %8)
  %10 = getelementptr inbounds %struct.Number, %struct.Number* %2, i32 0, i32 1
  %11 = load i8, i8* %10, align 4
  %12 = trunc i8 %11 to i1
  %13 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEb(%"class.std::basic_ostream"* %9, i1 zeroext %12)
  %14 = getelementptr inbounds %struct.Number, %struct.Number* %2, i32 0, i32 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_structures.cpp() #0 section ".text.startup" {
...
!1 = !{!"clang version 8.0.0 (tags/RELEASE_800/final 364945)"}
