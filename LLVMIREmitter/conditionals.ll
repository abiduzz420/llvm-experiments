; ModuleID = 'conditionals.cpp'
source_filename = "conditionals.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_conditionals.cpp, i8* null }]
...
entry:
  ...
  %call = call i32 @_Z3maxii(i32 22, i32 23)
  store i32 %call, i32* %maxval, align 4
  %0 = load i32, i32* %maxval, align 4
  ret i32 %0
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_Z3maxii(i32 %i, i32 %j) #5 {
entry:
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_conditionals.cpp() #0 section ".text.startup" {
entry:
